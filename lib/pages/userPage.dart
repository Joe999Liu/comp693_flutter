        ...
        children: <Widget>[
          Tapped(
            child: _UserRightButton(
              title: widget.isSelfPage ? '' : 'Follow',
            ),
          ),
        ],
      ),
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    TextGroup('9', 'Following'),
                    TextGroup('999', 'Followers'),
                    TextGroup('999', 'Likes'),
                  ],
                ),
              ),
      ...
      children: <Widget>[
        Container(
          ...
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: <Widget>[
              _PointSelectTextButton(true, 'Posts'),
              _PointSelectTextButton(false, 'Following'),
              _PointSelectTextButton(false, 'Likes'),
            ],
          ),
        ),
        Container(
